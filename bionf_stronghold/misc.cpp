...
// mathematical exercise regarding the reproduction of a population of rabbits.
...
int num_rabbit_pairs(int n_months, int k_pairs) {
  ...
  // total # rabbit pairs alive = # rabbits alive in previous month  + #
  // offspring created # offspring = # rabbits alive 2 months prior * k
  gens[n_months] = num_rabbit_pairs(n_months - 1, k_pairs) +
                   (num_rabbit_pairs(n_months - 2, k_pairs) * k_pairs);
